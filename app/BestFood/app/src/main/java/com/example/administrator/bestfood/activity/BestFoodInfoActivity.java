...
import com.example.administrator.bestfood.custom.WorkaroundMapFragment;
...
public class BestFoodInfoActivity extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        movePosition(new LatLng(item.latitude, item.longitude), MAP_ZOOM_LEVEL_DETAIL);
    }
