package com.example.administrator.bestfood.fragment.map;
...
import com.example.administrator.bestfood.adapter.MapListAdapter;
...
public class BestFoodMapFragment extends Fragment
    ...
    int currentZoomLevel = MAP_ZOOM_LEVEL_DETAIL;
    ...
    List<FoodInfoItem> infoList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_best_food_map, container, false);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        if (GeoItem.getKnownLocation() != null) {
            movePosition(GeoItem.getKnownLocation(), MAP_ZOOM_LEVEL_DETAIL);
        }
        showList();
    }
    ...
    private void listMap(int memberSeq, LatLng latLng, int distance, LatLng userLatLng) {
        ...
        Call<List<FoodInfoItem>> call = remoteService.listMap(memberSeq, latLng.latitude,
     ...
     * @param list 맛집 리스트
     */
    private void setMap(List<FoodInfoItem> list) {
    ...
    private void addMarker(List<FoodInfoItem> list) {
    ...
    private void showList() {
        ...
        if (currentZoomLevel < MAP_MAX_ZOOM_LEVEL) {
